...
Subscribe_CallBack = Callable[[str, str], None]
...
class Client:
    ...
    def __init__(
        ...
        subscribe: Callable[
            [Sub_State, str, Subscribe_CallBack], Coroutine[Any, Any, dict]
        ],
    ...
    async def subscribe(
        self, unique_id: int, topic: str, callback: Subscribe_CallBack
    ) -> None:
        ...
        if self._subscribe:
            ...
            # from all subscribed topic states create/get one that match the hash
    ...
    async def unsubscribe(self, unique_id: int, topic: str) -> None:
        ...
        if self._unsubscribe:
            ...
            # update the substate
            del self._substates[hash_value]
